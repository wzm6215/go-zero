  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        [process.env.VITE_BASE_API_1]: { // 需要代理的路径   例如 '/api'
          target: `${process.env.VITE_BASE_PATH_1}:${process.env.VITE_SERVER_PORT_1}/`, // 代理到 目标路径
          changeOrigin: true,
          rewrite: path => path.replace(new RegExp('^' + process.env.VITE_BASE_API_1), ''),
        },
      },
    },
    build: {
